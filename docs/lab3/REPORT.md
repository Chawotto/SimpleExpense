...
2.  **Стратегия развертывания:** Облачная (Cloud-based). Использование Firebase Hosting для статики и Cloud Firestore для данных. Это избавляет от необходимости поддержки собственного сервера.
